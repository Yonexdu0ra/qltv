...
class AccountServices {
  ...
  static getAllAccountWithPagination(query = {}, options = {}) {
    ...
    return accountRepository.findWithPagination(query, {
      limit,
      offset,
      order,
      ...options,
  ...
  static getAllAccountWithUserPagination(query = {}, options = {}) {
    ...
    return accountRepository.findWithUserPagination(where, {
      userWhere,
      limit,
      offset,
      order,
  ...
  static async updateAccountById(data, id, options = {}) {
    const [updatedRow] = await accountRepository.update(
      data,
      { id },
      { ...options }
    );
  ...
  static async reissuePasswordAccountById(id, newPassword) {
    try {
      ...
      const [isUpdated] = await accountRepository.update(
