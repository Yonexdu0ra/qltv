...
class FineRepository {
    ...
    static async findFilesPagination({ offset = 0, limit = 10, order = [['createdAt', 'DESC']], where = {} }, options = {}) {
    ...
    static async findFilesPaginationWithBorrowDetailAndBorrower({ offset = 0, limit = 10, order = [['createdAt', 'DESC']], where = {} }, options = {}) {
        return Fine.findAndCountAll({
            where,
            offset,
            limit,
