...
class HomeController {
    ...
    static async renderViewDashboard(req, res) {
        try {
            const { bookRepository, authorRepository, genreRepository, userRepository, borrowRepository,  } = require('../repositories');
            ...
            const [
              ...
              borrowServices.countBorrows(),
               await fineServices.sumAmount('amount', { is_paid: false }) 
            ]);
